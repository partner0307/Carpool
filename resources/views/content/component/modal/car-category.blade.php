<!-- Edit User Modal -->
<div class="modal fade" id="car-category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Car Category</h1>
                    <p>Add new category for your cars.</p>
                </div>
                <form id="editCategory" class="row gy-1 pt-75">
                    ...
                    <div class="col-12">
                        <label class="form-label" for="average">Average/Km</label>
                        <input type="number" class="form-control" id="average" name="average" placeholder="Average/km" data-msg="Please enter average per km" />
                    </div>
                    <div class="col-12">
